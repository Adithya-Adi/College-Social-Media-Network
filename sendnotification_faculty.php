...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
    $name=$row['name'];
	$sql = "INSERT INTO notification (name, notification, date) VALUES('".$name."','".$_POST['notification']."','".$date."');";
...
<div style="margin: 30px;">
  <div class="container" style="border: 1px solid;border-color: rgb(233, 229, 229); background-color: white;padding: 0;">
    <h1 style="text-align: center;  font-family: Roboto, sans-serif;color:rgb(255, 252, 252);background-color: rgb(101, 189, 227);">Send Notification</h1>
  <form style="margin:40px" method="post" enctype="multipart/form-data">
    ...
    <br>
  <button name="Submit" class="btn btn-success" style="margin-left:450px">Send</button>
