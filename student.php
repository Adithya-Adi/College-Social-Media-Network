...
if(isset($_POST['Submit']))
{
    ...
    move_uploaded_file($_FILES['profile']['tmp_name'],"assets/studentdp/" . $postimg);
    }
		$sqlupd ="UPDATE student SET name='".$_POST['name']."', email='".$_POST['email']."',phone='".$_POST['phone']."',stream='".$_POST['stream']."',profile='".$postimg."' WHERE email='" . $_SESSION['student'] . "'";
		$qsqlupd = mysqli_query($conn,$sqlupd);
    echo mysqli_error($conn);
    if(mysqli_affected_rows($conn) == 1)
    {
						$_COOKIE['student']=$_POST['email'];
...
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
		$sql = "INSERT INTO post (name,post_img,post_msg,date,role,id) VALUES ('".$row['name']."','".$postimg."','".$post."','".$date."','student',".$row['student_id'].");";
...
<body>
    <header id="header" class="header fixed-top d-flex align-items-center" style="padding:0px">
        <div class="container d-flex align-items-center justify-content-between" >
          ...
          <div id="logo" style="margin-right:450px;">
...
<div class="page-profile">
	<div class="row" style="background-color: rgb(233, 229, 229);width:1270px">
	<?php
						$sqledit = "SELECT * FROM student WHERE email='" . $_COOKIE['student'] . "'";
			...
			<section class="panel">
				<div class="panel-body noradius padding-10">
					<figure class="margin-bottom-10"><!-- image -->
						<img class="img-responsive" src="./assets/studentdp/<?php echo $rsedit['profile']?>" alt="">
					</figure><!-- /image -->
					...
					<ul class="list-unstyled size-13" style="margin-left: 10px;">
						...
						<li class="text-gray"> <?php echo $rsedit['stream']; ?> </li>
						<li><?php echo $rsedit['phone']; ?> </li>
						<li><?php echo $_COOKIE['student']; ?> </li>
					</ul><!-- /updated -->
						...
						<ul class="comment list-unstyled padding-10">
							<li class="comment">
								...
								<ul class="list-inline size-11 margin-top-10">
									...
									<li>
										<a href="student.php?editid=<?php echo $row['post_id'];?>" class="text-success"><i class="fa fa-thumbs-up"></i> Like</a>
									</li>
									<!-- <li>
