...
{
  echo "<script>window.location='examtimetable.php';</script>";  
}
else {
?>
<!DOCTYPE html>
...
<div style="margin: 30px;">
  <div class="container" style="border: 1px solid;border-color: rgb(233, 229, 229); background-color: white;padding: 0;">
    <h1 style="text-align: center;  font-family: Roboto, sans-serif;color:rgb(255, 252, 252);background-color: rgb(101, 189, 227);">Exam Time Table</h1>
  <form style="margin:40px">
<br>
<?php
$stream=$_POST['stream'];
$semester=$_POST['semester'];
$sql="select * from exam_timetable where stream='".$stream."' and semester='".$semester."';";
$result = $conn->query($sql);
if ($result->num_rows > 0) {
  while($row = $result->fetch_assoc()) {
?>
<iframe src="./assets/examtimetable/<?php echo $row['timetable']?>" width="100%" height="500px"></iframe>

   <br><br>
   <a href="./assets/examtimetable/<?php echo $row['timetable']?>" class="btn btn-success" style="margin-left:450px" Download>Download</a>
