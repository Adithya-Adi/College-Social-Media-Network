...
if(isset($_POST['Submit']))
{
  ...
  if($_FILES['postimg']['name']){
    ...
    move_uploaded_file($_FILES['postimg']['tmp_name'],"assets/facultydp/" . $postimg);
    }
	$sql = "INSERT INTO faculty (name, email,phone,department,password,profile)
	VALUES ('".$_POST['name']."','".$_POST['email']."','".$_POST['phone']."','".$_POST['department']."','".$_POST['password']."','".$postimg."');";
	if ($conn->query($sql) === TRUE) {
		echo "<script>alert('Faculty added Successfull');</script>";
	} else {
...
<div style="margin: 30px;">
  <div class="container" style="border: 1px solid;border-color: rgb(233, 229, 229); background-color: white;padding: 0;">
    <h1 style="text-align: center;  font-family: Roboto, sans-serif;color:rgb(255, 252, 252);background-color: rgb(101, 189, 227);">Faculty</h1>
  <form style="margin:40px" action="" method="post" enctype="multipart/form-data">
