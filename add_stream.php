...
if(isset($_POST['Submit']))
{
	...
	$sql = "INSERT INTO stream (stream,semester) VALUES ('".$_POST['stream']."',".$_POST['semester'].");";
	if ($conn->query($sql) === TRUE) {
		echo "<script>alert('Stream added Successfull');</script>";
	} else {
...
<div style="margin: 30px;">
  <div class="container" style="border: 1px solid;border-color: rgb(233, 229, 229); background-color: white;padding: 0;">
    <h1 style="text-align: center;  font-family: Roboto, sans-serif;color:rgb(255, 252, 252);background-color: rgb(101, 189, 227);">Stream</h1>
  <form style="margin:40px" method="post">
    <div class="form-group">
      <label>Stream Name</label>
      <input type="text" placeholder="Enter Stream Name" name="stream" class="form-control" required>
    </div>
    <div class="form-group">
      <label>Total Semester</label>
      <input type="number" placeholder="Enter Semester" name="semester" class="form-control" required>
    </div>
    <!-- <div class="form-group">
      <label>Status</label>
