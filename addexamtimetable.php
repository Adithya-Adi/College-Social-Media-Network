...
{
  $timetable = rand() . $_FILES['examtimetable']['name'];
  move_uploaded_file($_FILES['examtimetable']['tmp_name'],"assets/examtimetable/" . $timetable);
	$sql = "INSERT INTO exam_timetable (stream,semester,timetable) VALUES ('".$_POST['stream']."','".$_POST['semester']."','".$timetable."');";
...
<div style="margin: 30px;">
  <div class="container" style="border: 1px solid;border-color: rgb(233, 229, 229); background-color: white;padding: 0;">
    <h1 style="text-align: center;  font-family: Roboto, sans-serif;color:rgb(255, 252, 252);background-color: rgb(101, 189, 227);">Exam timetable</h1>
  <form style="margin:40px" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="file" class="form-control" name="examtimetable" id="timetable" required>
    </div>
    <br>
  <button class="btn btn-success" name="Submit" style="margin-left:450px">Upload</button>
