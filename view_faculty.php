...
if(isset($_GET['delid']))
{
    $sqldel = "DELETE FROM faculty WHERE faculty_id='" . $_GET['delid'] . "'";
    $qsqldel = mysqli_query($conn,$sqldel);
    echo mysqli_error($conn);
    if(mysqli_affected_rows($conn) == 1)
    {
        echo "<script>alert('Faculty Record deleted successfully..');</script>";
        echo "<script>window.location='view_faculty.php';</script>";
    }
}
?>
<!DOCTYPE html>
      ...
      <ul>
        ...
        <li class="dropdown"><a href="#" style="text-decoration: none;"><span>Accounts</span> 	<i class="bi bi-chevron-down"></i></a>
          <ul>
            ...
            <li><a href="addfaculty.php" style="text-decoration: none;">Add Faculty</a></li>
...
<div style="margin: 30px;">
  <div class="container" style="border: 1px solid;border-color: rgb(233, 229, 229); background-color: white;padding: 0;">
    <h1 style="text-align: center;  font-family: Roboto, sans-serif;color:rgb(255, 252, 252);background-color: rgb(101, 189, 227);">Faculty Accounts</h1>
    <table class="table">
  ...
  while($row = $result->fetch_assoc()) {
	?>
        <tr>
          ...
          <td><a href="view_faculty.php?delid=<?php echo $row['faculty_id']?>" class="btn btn-danger" onclick="return confirmdel()" style="margin-left: 5px;width: 80px;">Delete </a></td>
        </tr>
        <?php
	}
}
...
<a href="admindashboard.php" class="btn btn-success" style="margin-left: 550px;">Back</a><br><br>

</div>
</div>
<!--Footer-->
<div class="footer-basic" style="position: fixed;bottom: 0;right: 0;
    left: 0;">
  <footer>
