...
if(isset($_GET['delid']))
{
    $sqldel = "DELETE FROM adminacc WHERE admin_id='" . $_GET['delid'] . "'";
...
<div style="margin: 30px;">
  <div class="container" style="border: 1px solid;border-color: rgb(233, 229, 229); background-color: white;padding: 0;">
    <h1 style="text-align: center;  font-family: Roboto, sans-serif;color:rgb(255, 252, 252);background-color: rgb(101, 189, 227);">Admin Accounts</h1>
    <table class="table">
  ...
  while($row = $result->fetch_assoc()) {
	?>
        <tr>
          ...
          <td><a href="viewadmin.php?delid=<?php echo $row['admin_id']?>" class="btn btn-danger" onclick="return confirmdel()" style="margin-left: 5px;width: 80px;">Delete </a></td>
        </tr>
        <?php
	}
}
